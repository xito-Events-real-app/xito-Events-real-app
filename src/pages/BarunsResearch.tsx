...
export default function BarunsResearch() {
  ...
  const content = (
    <div className="min-h-screen bg-background">
      <div className="sticky top-0 z-30 bg-background/95 backdrop-blur-sm border-b border-border px-4 md:px-6 py-3 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold leading-tight">Barun's Research</h1>
          <p className="text-[11px] text-muted-foreground">Quotation, payments, project files & catalogs</p>
        </div>
      </div>
